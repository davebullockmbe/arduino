...
const byte MENU_ATTENUATION_50dB      = 5;
...
const int MIN_INPUT_DBM         = -55;          // Minimum input power. If less then consider as 'not connected'.
...
const char BANDS[BAND][6]   = {"  HF ", "  6m ", "  2m ", " 70cm", " 23cm", " 13cm", "  6cm", "  3cm" };  // List of BANDS we know settings data of.
const float DBM_AT_0V[BAND] = {  16.92,   16.92,   16.74,   16.56,   15.14,   14.10,   16.80,   21.80 };  // dBm value at 0V (Intercept)
...
const float MV_DB_SLOPE         = 0.0210;        // Slope of AD8317 characteristics in -mV/dBm. Is the same for all BANDS. 
//
